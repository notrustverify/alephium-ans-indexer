...
const ProductionConfig = {
    ...
    PUBLIC_ADDRESS: '1GBvuTs4TosNB9xTCGJL5wABn2xTYCzwa7MnXHphjcj1y'
};
const getConfig = () => {
    ...
    if (DEPLOYMENT === exports.DEPLOYMENTS.STAGING) {
        return StagingConfig;
    }
    if (DEPLOYMENT === exports.DEPLOYMENTS.STAGING_LOCAL) {
        return StagingLocalConfig;
    }
    if (DEPLOYMENT === exports.DEPLOYMENTS.PRODUCTION) {
